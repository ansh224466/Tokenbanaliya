...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7153847033:AAHDUderAYME9fZJgzfY7CX3WzAZYRRwPbQ")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002182559686"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1707099600 6616938712").split()):
        ADMINS.append(int(x))
except ValueError:
