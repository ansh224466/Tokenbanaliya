...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002227318714"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002033896146"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5787502520 6769369582 7430391742").split()):
        ADMINS.append(int(x))
except ValueError:
